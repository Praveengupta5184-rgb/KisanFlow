...
public final class KisanFlowDtos {
    ...
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class CentreResponse { private UUID id; private String name, address, status, district, state; private Double distanceKm; private BigDecimal latitude, longitude, processingSpeed; private Integer capacity, staffCount, currentLoad; }
    ...
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class InitiatePaymentRequest { @NotNull private UUID lotId; @NotNull private UUID traderId; @NotNull @DecimalMin("0") private BigDecimal amount; @NotBlank private String paymentMethod; @NotBlank private String paymentType; }
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class OfflinePaymentRequest { @NotNull private UUID paymentId; @NotBlank private String offlineReference; private String remarks; }
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class PaymentActionRequest { @NotNull private UUID paymentId; private boolean confirmed; private String remarks; }
    ...
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class PaymentResponse { private UUID id, bookingId, traderId, lotId, bidId; private BigDecimal amount; private String status, paymentMethod, paymentType, transactionId, offlineReference, remarks, proofUrl; private Boolean farmerConfirmation, delayFlag; private LocalDate expectedDate, actualDate; private OffsetDateTime initiatedAt, processedAt, farmerConfirmedAt, officerVerifiedAt, createdAt, updatedAt; }
    ...
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class LotResponse { private UUID id, bookingId, centreId; private String lotNumber; private BigDecimal actualWeight, basePrice, highestBidAmount; private UUID highestBidderId, highestBidId, acceptedBidId, winningTraderId; private String qualityGrade, status; private OffsetDateTime acceptedAt, auctionExpiresAt, createdAt, updatedAt; }
    ...
    @Data @NoArgsConstructor @AllArgsConstructor @Builder public static class BidResponse { private UUID id, lotId, traderId; private String traderName; private BigDecimal amount; private String status; private OffsetDateTime createdAt; }
}
